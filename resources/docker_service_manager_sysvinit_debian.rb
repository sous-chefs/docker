resource_name :docker_service_sysvinit_debian

provides :docker_service, platform: 'debian' do |node| # ~FC005
  node['platform_version'].to_f < 8.0
end

provides :docker_service_sysvinit, platform: 'debian' do |node|
  node['platform_version'].to_f < 8.0
end
