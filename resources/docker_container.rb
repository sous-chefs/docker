...
# The non-standard types [true, false], ArrayType, ShellCommand, etc
...
property :autoremove, [true, false], desired_state: false
...
property :init, [true, false, nil], default: false
