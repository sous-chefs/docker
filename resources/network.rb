...
property :auxiliary_addresses,
          [String, Array],
          coerce: proc { |v| coerce_auxiliary_addresses(v) }
...
property :driver_opts,
          PartialHashType

property :enable_ipv6,
          [true, false]

property :gateway,
          [String, Array],
          coerce: proc { |v| coerce_gateway(v) }
...
property :ip_range,
          [String, Array],
          coerce: proc { |v| coerce_ip_range(v) }

property :ipam_driver,
          String
