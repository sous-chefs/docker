...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :debian7 do |debian7|
    ...
    debian7.vm.box_url  = 'https://opscode-vm-bento.s3.amazonaws.com/vagrant/opscode_debian-7.1.0_provisionerless.box'
    debian7.vm.hostname = 'docker-debian-7'
  end

  config.vm.define :fedora18 do |fedora18|
    fedora18.vm.box      = 'opscode-fedora-18'
    fedora18.vm.box_url  = 'https://opscode-vm-bento.s3.amazonaws.com/vagrant/opscode_fedora-18_provisionerless.box'
    fedora18.vm.hostname = 'docker-fedora-18'
  end

  config.vm.define :fedora19 do |fedora19|
    fedora19.vm.box      = 'opscode-fedora-19'
    fedora19.vm.box_url  = 'https://opscode-vm-bento.s3.amazonaws.com/vagrant/opscode-fedora-19_provisionerless.box'
  ...
  config.vm.define :ubuntu1210 do |ubuntu1210|
    ...
    ubuntu1210.vm.box_url  = 'https://opscode-vm-bento.s3.amazonaws.com/vagrant/opscode_ubuntu-12.10_provisionerless.box'
